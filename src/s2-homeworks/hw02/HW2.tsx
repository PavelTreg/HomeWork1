...
if (filter==='all') {
    ...
    /*
 if (filter === 'high') {
      affairs.filter((filteredAffairs)=>filteredAffairs.priority === 'high')
 }
    if (filter === 'middle') {
        affairs.filter((filteredAffairs)=>filteredAffairs.priority === 'middle')
    }
    if (filter === 'low') {
         affairs.filter((filteredAffairs)=>filteredAffairs.priority === 'low')
    }
*/
...
function HW2() {
    ...
    const deleteAffairCallback = (_id: number) => { // need to fix any+
      let removeAffair = defaultAffairs.filter( t => {
          if (t._id !== _id) {
              return true
          }
          else {
